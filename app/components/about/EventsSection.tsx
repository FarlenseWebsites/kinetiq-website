    ...
    <section className="bg-[#F4F4F4] py-16 sm:py-20">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <p className="mt-3 text-[#8681a5] text-sm sm:text-base text-center max-w-md">
            Catch up on what we&apos;ve done and what&apos;s coming next at KinetiQ.
          </p>
        </motion.div>
        ...
        >
          <SubsectionHeader label="Upcoming Events" badge="upcoming" />
