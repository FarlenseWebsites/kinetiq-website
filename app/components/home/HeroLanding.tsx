...
export default function HeroLanding() {
  return (
    <section className="relative isolate min-h-screen overflow-hidden bg-[#F9F9F9]">
      {/* Background */}
      <HeroBackground />
      ...
      <div className="relative z-10 flex justify-center px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="overflow-hidden">
            <motion.h1
              variants={revealItem}
              className="font-bold italic leading-tight tracking-tight"
              style={{
          ...
          <div className="mt-6 overflow-hidden sm:mt-8">
            <motion.p
              ...
              "
              style={{
                fontSize: "clamp(0.813rem, 1.5vw + 0.25rem, 1.125rem)",
              }}
            >
          ...
          >
            ...
            <p className="text-[clamp(0.625rem,1.1vw,0.75rem)] italic tracking-wide text-slate-300">
              Recovery and Fitness Backed by Science
            </p>
          </motion.div>
        </motion.div>
      </div>
