		...
		<div className="absolute inset-0 z-0 min-h-[100svh] overflow-hidden pointer-events-none">
			<motion.div
				...
				className="
					...
					min-[1024px]:[clip-path:ellipse(72%_58%_at_50%_-10%)]
					min-[1050px]:[clip-path:ellipse(52%_86%_at_50%_0%)]
				"
				style={{
					background:
						"linear-gradient(180deg, #ffffff 0%, #dcd8e8 20%, #68628E 90%, #373355 100%)",
